...
public class PropertiesList extends Properties {
    ...
    /**
     * Set the Prefix of this PropertiesList.
     * If "prefix" is non-null, then <code>propertyNames(pattern)</code>
     * won't enumerate any properties unless "prefix" starts with "pattern".
     * @return	The previous value of the prefix
     */
    ...
    /**
     * Returns the enumeration prefix.
     */
	...
	if (next != null && ! searchNextFirst) {
        ...
        if (prefix == null || pattern==null || pattern.startsWith(prefix)) {
	    Enumeration e;
	    if (wrapped instanceof Properties) {
