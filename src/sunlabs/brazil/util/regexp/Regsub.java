 ...
 * Last modified by suhler on 09/11/03 10:27:24
 *
 * Version Histories:
 *
 * 2.4 09/11/03-10:27:24 (suhler)
 *   add reset() to allow object reuse
 *
...
public class Regsub
{
     ...
     * This allows an object to be reused with a 
     * different string
     */

    public void reset(String resetString) {
	this.str = resetString;
	this.ustart = 0;
	this.mstart = -1;
	this.end = 0;
    }
