 ...
 * Last modified by suhler on 09/02/12 14:03:02
 *
 * Version Histories:
 *
 * 2.8 09/02/12-14:03:02 (suhler)
 *   add stringToInt utility method, should replace most inline version with it
 *
...
public class Format {
    ...
    /**
     * Convert a string to an integer; use a default value if the
     * conversion fails.
     * @param	value	the value to attemp conversion of
     * @param	dftl	The result if the value is not a valid number
     * @return	The integer value of "value", or "dflt" if value is NAN.
     */
