 ...
 * Last modified by suhler on 09/04/22 11:59:01
 *
 * Version Histories:
 *
 * 2.8 09/04/22-11:59:01 (suhler)
 *   add toString() option to specify item delimiter
 *
 * 2.7 08/03/04-11:08:11 (suhler)
 *   javadoc fixes
 *
 * 2.6 08/03/04-10:57:51 (suhler)
 *   StringMap.java
 *
    ...
    extends Dictionary<String, String>
{
     ...
     *		The index of the key.
     *
     * @param	value at the specified index.
     *
     * @throws	IndexOutOfBoundsException
     *		if the index is out of the allowed range.
     */
	...
	if (i >= 0) {
	    String prior = values.elementAt(i);
	    remove(i);
	    return prior;
	}
	return null;
