 ...
 * a set of properties, which can be manipulate as a set of name/value
 * pairs using the
 * standard mechanisms, then turned it back into a JSON object again.
 * </dl>
 * <p>
 ...
 * with the JSON generated by the "object", "array" and "item" tags.
 * <ul>
...
public class JSONTemplate extends Template {
 ...
 .    * Recursively extract a json object into a set of properties
  ...
  popHelper(RewriteContext hr) {
    if (stack.size() == 1) return;	// we are the root;
    Object me = stack.pop();
    Object parent = stack.peek();
  ...
  public boolean
    ...
    if (items.isEmpty()) return true;	// XXX temp
