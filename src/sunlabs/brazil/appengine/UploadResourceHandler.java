 ...
 */
public class UploadResourceHandler extends Template implements Handler  {
  MatchString isMine;
  String namespace;
  ...
  /**
   * Upload a file from query data.  Be careful how this tag is used,
   ...
   * This doesn't really belong here, but it's useful in conjunction with uploading.
   ...
   * This is temporary until the normal namespace load/store'll do it for us.
   * 
